...
private:
     ...
     */
    static void
    RemainCollision(const std::shared_ptr<GameObject> &initiator, const std::shared_ptr<Collider> &init_collider,
                    const std::shared_ptr<GameObject> &receiver, const std::shared_ptr<Collider> &rec_collider,
     ...
     */
    static auto CheckBoxCollision(Point aPos, const BoxCollider &aCol, Point bPos,
